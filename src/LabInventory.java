           ...
           */
	       ...
	       while (b ==true) {
	    	...
	    	break;   
	          ...
	          while (op == 4) {
	        	  System.out.println("Items that are less than 5 in store. Please make order now for satisfaction of our customers.");
	        	  for(i=0; i<n; i++) {
	        		  qty = itemDatabase[i].getQuantity();
	        		  if (qty<5) {
	        			  
	        			  System.out.println("Item Id: " + itemDatabase[i].getItemID() + "\n" +"Name: " +  itemDatabase[i].getName()
	        					  + "\n" + "From: " +  itemDatabase[i].getSupplier() + "\n" + "Supplier contacts: " + 
	        					  itemDatabase[i].getSupplierInfo());
	        		  }
	        		  else {
	        			  continue;
	        		  }
